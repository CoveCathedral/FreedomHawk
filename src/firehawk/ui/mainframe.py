...
class MainFrame(wx.Frame):
    ...
    def _on_drums_help(self, event) -> None:
        wx.MessageBox(
            ...
            "   Hip-Hop, Trap, House, Techno, DnB, Reggae, Latin, Jazz, 5/4, 7/8, 9/8,\n"
            ...
            "   Ctrl by beat, Ctrl+Shift by bar; Space cycles a step on/accent/ghost/\n"
            "   off; minus/plus set a line's own loop length for polymeter (parts in\n"
            "   different lengths that phase against each other); Enter picks the\n"
            ...
            "   time signature (odd meters too) is set here, along with Swing (shuffle\n"
            "   feel) and Humanize (subtle timing/volume drift) - both save WITH the\n"
            "   groove, so a shuffle keeps its shuffle.\n"
            ...
            "7. Set the Tempo and Drum volume, then press Start. (Swing and Humanize now\n"
            "   live in the Pattern Editor, saved with each groove.)\n\n"
